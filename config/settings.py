...
SECRET_KEY = 'django-insecure-)!yy#@6yrbq%66@lzu53w5$1ix5%zjg@4f!ff$e5(@y$rqus$o'
...
STATIC_ROOT = BASE_DIR / "staticfiles"  # where collectstatic puts the
